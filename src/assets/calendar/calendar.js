...
document.write('<table id="fc" style="display:none;" class="popup-date" cellpadding="2">');
document.write('<tr class="select-month" onselectstart="return false"><td onclick="upmonth(-1)">&#8592;</td><td colspan="5" id="mns" align="center"></td><td align="right"  onclick="upmonth(1)">&#8594;</td></tr>');
document.write('<tr class="date-header"><td align=center>Пн</td><td align=center>Вт</td><td align=center>Ср</td><td align=center>Чт</td><td align=center>Пт</td><td align=center>Сб</td><td align=center>Вс</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#fff2df;" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function f_cps(obj) {
	...
	obj.style.border='1px solid #510400';//'1px solid #606060';
