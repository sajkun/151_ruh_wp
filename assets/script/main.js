...
//             if(meta[id] === 'treatment_coordinator'){
//               var specialist = vm.base_lead.meta[meta[id]].specialist;
//               var _s = [];
//               for(var i in specialist){
//                 if(specialist[i] && specialist[i].length > 2){
//                   _s.push(specialist[i]);
//                 }
//               }
//               vm.base_lead.meta[meta[id]].specialist = _s;
...
//         vm.phones   = vm.base_lead.phone_count;
//         vm.messages = vm.base_lead.messages_count;
