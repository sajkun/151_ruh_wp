...
Vue.component('list-column', {
  ...
  mounted: function(){
    ...
    header.style.backgroundColor = this.data.bg_color;
    header.style.color           = this.data.text_color;
  },
  ...
  <div class="leads-column">
    <div class="leads-column__head">
      ...
      <span class="leads-column__convertion"><svg class="icon svg-icon-convertions"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-icon-convertions"></use></svg>
         {{converted}}
       </span>
    </div>
    <div class="leads-column__body">
      <ul name="lead-list" data-list="New" class="leads-list ui-sortable" style="min-height: 2225px;">
...
if(document.getElementById('list-app') && 'undefined' != typeof(is_lead_list_2)){
  list_app = new Vue({
    ...
    mounted: function(){
      var heigth = jQuery('.site-inner').height() - jQuery('.filter-container').height() - 30;

      // set width of columns' container to avoid line breaks
      jQuery(this.$refs.column_container).css({
        'min-width' : this.stages.length * 300 + 'px',
      })
    ...
    computed: {
      ...
      leads_filtered: function(){
        ...
        var leads = vm.leads.filter(function(el){
          var validated = true;
