...
function add_leads_stage(){
  ...
  var template = '<li> <div class="stages-content__item"> <table> <tr> <th colspan="4"> <h3>Stage #<span class="number">{number}</span></h3> <input type="hidden" name="leads_stages[{count}][number]" class="stage_order" value="{number}"> <a  href="javasctipt:void(0)" onclick="delete_leads_stage(this);">Delete Stage</a> </th> </tr> <tr> <th>Name</th> <td colspan="3"><input type="text" class="regular-text" name="leads_stages[{count}][name]" value=""></td> </tr> <tr> <th>Background Color</th> <td><input type="text" class="small-text colorpicker new" name="leads_stages[{count}][bg_color]" value=""></td> <th>Text Color</th> <td><input type="text" class="small-text colorpicker new" name="leads_stages[{count}][text_color]" value=""></td> <tr><td colspan="4"> <label class="optional_label"> <input type="radio" name="stage_for_converted" class="stage_for_converted" value="{count}"> Is converted <br> <i>Leads on this stage, and all stages with hire numbers ,  will be counted as converted</i> </label> <label class="optional_label"> <input type="checkbox" name="stage_for_failed[]" class="stage_for_failed" value="{count}"> Is failed <br> <i>Leads on this stage, will be counted as failed</i> </label> </td></tr></tr> <tr> <th> Show for role: </th> <td colspan="3" class="th"> <label> <input type="hidden" value="0" name="leads_stages[{count}][reception]"> <input type="checkbox" value="1" name="leads_stages[{count}][reception]" > Reception </label> <label> <input type="hidden" value="0" name="leads_stages[{count}][tco]"> <input type="checkbox" value="1" name="leads_stages[{count}][tco]" > TCO </label> </td> </tr> </table> </div> </li>';
