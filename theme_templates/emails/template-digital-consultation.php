    ...
    <div style="background: #fff; box-sizing: inherit; display: block; margin: 0 auto; max-width: 546px; padding: 5px;">
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;">I
                        have listed below some ideas on the costings of treatment
                        options available
                    </span>
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <b
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; font-weight: bolder; margin: 0; outline: 0;">TREATING
                        DENTIST </b>
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;"><?php echo $dentist; ?></span>
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="background-color: #b2a687; border-radius: 9999px; box-sizing: inherit; color: #fff; display: inline-block; font-size: 8px; padding: 4px 10px; text-transform: uppercase;">STAGE
                        1</span>
                    <div style="box-sizing: inherit; height: 20px;"></div>
                </td>
                <td style="box-sizing: inherit; width: 30px;" width="30"></td>
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="box-sizing: inherit; color: #000; font-family: sans-serif; font-size: 18px; font-weight: 600; margin: 0;"><?php echo $stage_1['title']; ?></span>
                    <div style="box-sizing: inherit; height: 20px;"></div>
                </td>
                <td style="box-sizing: inherit; width: 30px;" width="30"></td>
            </tr>
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;">We
                        will always begin by ensuring your teeth and gums are healthy.
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td style="border-bottom: 1px solid #eeeded; box-sizing: inherit; padding: 20px 0;">
                    ...
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;"><?php echo $item['description']; ?></span>
                </td>
                <td
                    style="border-bottom: 1px solid #eeeded; box-sizing: inherit; padding: 20px 0; text-align: right; vertical-align: middle;">
                    <span
                        style="box-sizing: inherit; color: #1a1c1a; font-family: serif; font-size: 12px; vertical-align: middle;"><?php echo $item['from']; ?>
                        £</span>
                    <span
                        style="border-bottom: 2px dashed #cbd5e3; box-sizing: inherit; color: #c29265; display: inline; font-family: serif; font-size: 30px; text-align: right; vertical-align: middle;">
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="box-sizing: inherit; color: #000; font-family: sans-serif; font-size: 18px; font-weight: 600; margin: 0;"><?php echo $stage_2['title']; ?></span>
                    <div style="box-sizing: inherit; height: 20px;"></div>
                </td>
                <td style="box-sizing: inherit; width: 30px;" width="30"></td>
            </tr>
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: left;">
                    <span
                        style="border-bottom: 3px solid #c29265; box-sizing: inherit; color: #1a1c1a; font-family: PoppinsFont,sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 2.44px; line-height: 24px; padding: 5px 0; text-transform: uppercase;">OPTION
                        1</span>
                    <div style="box-sizing: inherit; height: 20px;"></div>
                </td>
                <td style="box-sizing: inherit; width: 30px;" width="30"></td>
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: left;">
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;">To
                        see our specialist Orthodontist for a consultation and discuss
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: left;">
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;">
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit;">
                    <p
                        style="background-color: #ded5bf; box-sizing: inherit; color: #504b40; display: block; font-size: 12px; line-height: 20px; padding: 4px 5px;">
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit; text-align: center;">
                    <span
                        style="box-sizing: inherit; color: #000; font-family: sans-serif; font-size: 18px; font-weight: 600; margin: 0;"><?php echo $item['title']; ?></span>
                    <div style="box-sizing: inherit; height: 20px;"></div>
                </td>
                <td style="box-sizing: inherit; width: 30px;" width="30"></td>
            </tr>
            ...
            <tr style="box-sizing: inherit;">
                ...
                <td colspan="2" style="box-sizing: inherit;">
                    <span
                        style="border: 0; box-sizing: inherit; color: #1a1c1a; display: block; font-size: 13px; line-height: 20px; margin: 0; outline: 0;"><?php echo $stage_3['summary']; ?></span>
                </td>
                <td style="box-sizing: inherit; width: 30px;" width="30"></td>
            </tr>
        </table>
