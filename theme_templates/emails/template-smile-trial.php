    ...
    <div
                ...
                <td style="box-sizing: inherit; line-height: 0; overflow: hidden; vertical-align: top;">
                    <div style="background: #000; box-sizing: inherit; line-height: 1.2; padding: 34px 20px 30px 40px;">
                        ...
                        <p
                            ...
                            Smile Trial</p>
                        <span
                            style="box-sizing: inherit; color: #fff; display: block; font-family: 'Helvetica Neue',sans-serif; font-size: 13px; font-style: normal; font-weight: 500; letter-spacing: normal; line-height: 22px; margin: 0; text-align: left;">See
                            what your new smile could look like in minutes.</span>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr
                ...
                <td style="box-sizing: inherit; padding: 0 45px 20px;">
                    <div style="box-sizing: inherit; text-align: center;">
                        <div style="box-sizing: inherit; height: 20px;"></div>
                        <img src="<?php echo THEME_URL; ?>/assets/images/letter/before_after.jpg" alt width="272"
                            height="230" style="border-style: none; box-sizing: inherit;">
                        <div style="box-sizing: inherit; height: 20px;"></div>
                    </div>
                </td>
            </tr>
            <tr
                ...
                <td style="box-sizing: inherit; padding: 0 45px 20px;">
                    <span
                        style="border-bottom: 3px solid #c29265; box-sizing: inherit; color: #1a1c1a; font-family: PoppinsFont,sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 2.44px; line-height: 24px; padding: 5px 0; text-transform: uppercase;">HOW
                        IT WORKS</span>
            ...
            <tr
                style="box-sizing: inherit; color: #1a1c1a; font-family: 'Helvetica Neue',sans-serif; font-size: 13px; line-height: 17px; text-align: left;">
                <td style="box-sizing: inherit; padding: 0 45px 20px;">
                    At the appointment composite filling material is temporarily
            ...
            <tr
                ...
                <td style="box-sizing: inherit; padding: 0 45px 20px;">
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
                        style="box-sizing: inherit; color: #1a1c1a; font-family: HelveticaFont_,sans-serif; font-size: 13px; line-height: 15px; width: 100%;">
                        <tr style="box-sizing: inherit;">
                            <td style="box-sizing: inherit; padding: 0 !important;">
                                <span
                                    style="box-sizing: inherit; color: #052116; font-family: PoppinsFont,sans-serif; font-size: 15px; font-weight: 600; line-height: 27px; margin: 0;">Smile
                                    Trial</span>
                            </td>
                            <td rowspan="2"
                                style="box-sizing: inherit; color: #000; font-family: 'Libre Baskerville',serif; font-size: 14px; font-weight: 400; line-height: 46px; padding: 0 !important; text-align: right; vertical-align: middle;">
                                from £</td>
                            <td rowspan="2"
                                style="box-sizing: inherit; color: #c29265; font-family: 'Libre Baskerville',serif; font-size: 30px; font-weight: 400; line-height: 46px; padding: 0 !important; text-align: left; vertical-align: bottom;">
                                85</td>
                        </tr>
                        <tr style="box-sizing: inherit;">
                            <td style="box-sizing: inherit; padding: 0 !important;">Initial examination and
                                complimentary trial smile</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr
                style="box-sizing: inherit; color: #1a1c1a; font-family: 'Helvetica Neue',sans-serif; font-size: 13px; line-height: 17px; text-align: left;">
                <td style="box-sizing: inherit; padding: 0 45px 20px;">
                    If you have any further questions or would like to speak to one of
                    our treatment coordinators, please don’t hesitate to ask.
                </td>
            </tr>
            <tr
                style="box-sizing: inherit; color: #1a1c1a; font-family: 'Helvetica Neue',sans-serif; font-size: 13px; line-height: 17px; text-align: left;">
