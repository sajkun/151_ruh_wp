    <div class="letter-body">
        ...
        <tr>
          <td>
            <textarea
              ...
              rows="4"
              class="textarea"
              placeholder="Enter dentist summary"
              v-model="template_data['Digital Consultation'].dentist_summary"
            ></textarea>
          </td>
        </tr>
      </table>
      ...
      >
        <tr>
          ...
          <td colspan="2" class="text-center">
            <span class="text"
              >I have listed below some ideas on the costings of treatment
              options available
            </span>
        ...
        <tr>
          ...
          <td colspan="2" class="text-center">
            <input
              type="text"
              placeholder="Enter dentists data there"
              class="single-line"
        ...
        <tr v-for="item, key in template_data['Digital Consultation'].stage_1.items" v-if="item.show">
          ...
          <td class="cell">
            ...
            <span class="text"
              ><input type="text" placeholder="Add short description" v-model="item.description"
            /></span>
          </td>
          <td class="cell right">
      ...
      >
        ...
        <tr>
          ...
          <td class="text-left" colspan="2">
            <span class="text"
              >To see our specialist Orthodontist for a consultation and discuss
        ...
        <tr>
          ...
          <td class="" colspan="2">
            <textarea
              ...
              v-model="template_data['Digital Consultation'].stage_3.summary"
            ></textarea>
          </td>
          <td class="margin"></td>
        </tr>
