...
<div class="letter-body">
        ...
        <tr>
            <td>
                <div class="letter-welcome-screen__col">
                    ...
                    <span class="comment-white"> We can’t wait to see you in our clinic and get your smile journey
                        started. </span>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <div class="text-block">
                    ...
                    <select-imitation2 _select_name="clinic" :_selected="'clinic'" :_options="select_data.clinics"
                        v-on:update_list="update_template_data($event, 'Booked In')"
                        :class="{'error': errors['Booked In'].clinic, 'relative': 1}" ref="clinics_select">
                    </select-imitation2> <br>
    ...
    <table class="black-block-option" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td>
                <p class="text">All of our treatment coordinators are highly skilled in the field of dentistry and will
                    be <br> able to discuss treatment options best suited to your needs, approximate price and <br>
                    payment plans. These consultations can be done either in house or via zoom.</p>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table class="grey-block-option" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td>
                ...
                <div class="text-center-element">
                    <input type="text" class="input" v-model="template_data['Booked In'].price">
                    <?php /*
                    <select-imitation2 _select_name="price" :_selected="'Price'" :_options="select_data.prices"
                        v-on:update_list="update_template_data($event, 'Booked In')"
        ...
        <tr>
            <td>
                <p class="text"> The dentist will complete a full mouth assessment and discuss treatment options best
                    suited to your needs. We are then able to provide you with a bespoke treatment plan and our team
                    will discuss all payment options, and appointment availability should you wish to proceed. The cost
                    of this is <span class="placeholder">{{template_data['Booked In'].price}}</span></p>
    ...
    <table class="text-block" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                We do require £50 as a holding deposit in order to secure your appointment with us at the time of
                booking. This is refundable if you would decide not to have treatment or we can credit this towards your
                treatment plan. <br>
            </td>
        </tr>
        <tr>
            <td>
                Please note that you will be with us at the clinic for approximately 1 hour whilst your dedicated
                Treatment Coordinator discusses your options in detail.<br>
            </td>
        </tr>
