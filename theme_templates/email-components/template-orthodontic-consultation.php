...
<div class="letter-body">
        ...
        <tr>
            <td>
                <div class="letter-welcome-screen__col">
                    ...
                    <span class="comment-white">Which orthodontic option is best for you?</span>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table class="most-popular-option-left" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
        style="
        ...
        <tr>
            <td>
                <span class="most-popular-option__text">Invisalign is a removable clear brace which when worn, enable
    ...
    <table class="list-table" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="margin"></td>
            <td>
                <div class="spacer-h-10"></div>
    ...
    <table class="pricing-table" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="margin"></td>
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].invisalign_braces.full.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].invisalign_braces.full.price' />
            </td>
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].invisalign_braces.lite.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].invisalign_braces.lite.price' />
            </td>
            <td class="remove-cell">
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].invisalign_braces.complex.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].invisalign_braces.complex.price' />
            </td>
            <td class="remove-cell">
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].invisalign_braces.consultation.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">£</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].invisalign_braces.consultation.price' />
            </td>
            <td class="remove-cell">
    ...
    <table class="lingual-braces-block" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"
        style="
        ...
        <tr>
            <td class="margin"></td>
            <td>
                <span class="lingual-braces-block__text">The most accurate, discreet and efficient way to move teeth.
    ...
    <table class="pricing-table" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].lingual_braces.full.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].lingual_braces.full.price' />
            </td>
            <td class="remove-cell">
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].lingual_braces.lite.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].lingual_braces.lite.price' />
            </td>
            <td class="remove-cell">
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].lingual_braces.consultation.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">£</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].lingual_braces.consultation.price' />
            </td>
            <td class="remove-cell">
    ...
    <table class="fixed-braces-block" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="
        ...
        <tr>
            <td class="margin"></td>
            <td>
                <span class="fixed-braces-block__text">Teeth can be straightened in a number of ways using Invisalign,
    ...
    <table class="pricing-table" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].fixed_braces.ceramic.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].fixed_braces.ceramic.price' />
            </td>
            <td class="remove-cell">
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].fixed_braces.metal.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">from £</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].fixed_braces.metal.price' />
            </td>
            <td class="remove-cell">
        ...
        <tr>
            ...
            <td class="cell">
                ...
                <span class="text">
                    <input type="text" placeholder="Add short description"
                        v-model='template_data["Orthodontic Consultation"].fixed_braces.consultation.description' /></span>
            </td>
            <td class="cell right">
                <span class="from">£</span>
                <input type="text" class="price"
                    v-model='template_data["Orthodontic Consultation"].fixed_braces.consultation.price' /></span>
            </td>
            <td class="remove-cell">
